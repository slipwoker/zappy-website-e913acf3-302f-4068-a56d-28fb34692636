document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function createSuccessMessage() {
            ...
            successMessage.style.cssText = 'color: #28a745; padding: 1rem; background: #d4edda; border-radius: 4px; margin-top: 1rem; display: none;';
    ...
    if (animatedElements.length > 0) {
        ...
        if (!document.getElementById('scroll-animation-styles')) {
            ...
            style.textContent = `
                .fade-in-hidden, .fade-in:not(.visible), [data-animate]:not(.visible) {
                    opacity: 0;
                    transform: translateY(20px);
                    transition: opacity 0.6s ease-out, transform 0.6s ease-out;
                }
                .fade-in.visible, [data-animate].visible {
                    opacity: 1;
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e913acf3-302f-4068-a56d-28fb34692636',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e913acf3-302f-4068-a56d-28fb34692636';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e913acf3-302f-4068-a56d-28fb34692636';
